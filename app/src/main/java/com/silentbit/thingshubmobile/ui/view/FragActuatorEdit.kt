...
import com.silentbit.thingshubmobile.databinding.FragActutorEditBinding
import com.silentbit.thingshubmobile.domain.objs.ObjActuator
import com.silentbit.thingshubmobile.ui.viewmodel.ViewModelActuatorEdit
...
class FragActuatorEdit : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtType.setText(actuator?.type)
